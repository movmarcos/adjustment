...
with tab_approval:
    ...
    _html(_card(
        ...
        "scope</strong>. FRTB (which this app shows as FRTBSBM), FRTBDRC and "
         "FRTBRRAO are signed off <strong>separately</strong> — they each "
         "have their own sign-off process, so signing off FRTB does not "
         "sign off DRC or RRAO. Once "
