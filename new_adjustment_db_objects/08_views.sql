...
SELECT
    ...
    h.BOOK_CODE,
    h.CURRENCY_CODE,
    -- Remaining filter dimensions (so My Work can show every applied filter)
    h.SOURCE_SYSTEM_CODE,
    h.TRADE_TYPOLOGY,
    h.TRADE_CODE,
    h.STRATEGY,
    h.INSTRUMENT_CODE,
    ...
    h.TRADER_CODE,
    h.VAR_COMPONENT_ID,
    h.VAR_SUB_COMPONENT_ID,
    h.VAR_COMPONENT_NAME,
    h.VAR_SUB_COMPONENT_NAME,
    h.GUARANTEED_ENTITY,
    h.REGION_KEY,
    h.SCENARIO_DATE_ID,
    h.TENOR_CODE,
    h.UNDERLYING_TENOR_CODE,
    h.CURVE_CODE,
    h.DAY_TYPE,
    h.PRODUCT_CATEGORY_ATTRIBUTES,
    h.BATCH_REGION_AREA,
    h.MUREX_FAMILY,
    h.MUREX_GROUP,
    h.SCALE_FACTOR,
...
SELECT
    ...
    h.DEPARTMENT_CODE,
    h.CURRENCY_CODE,
    -- Remaining filter dimensions (so the approver sees every applied filter)
    h.SOURCE_SYSTEM_CODE,
    h.TRADE_TYPOLOGY,
    h.TRADE_CODE,
    h.STRATEGY,
